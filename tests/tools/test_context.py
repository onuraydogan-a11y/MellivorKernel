"""Tests for mellivor_kernel.tools.context."""
...
from mellivor_kernel.tools import ToolContext
...
def test_context_holds_all_four_fields() -> None:
    ...
    context = ToolContext(configuration=settings, logger=logger, runtime=kernel, services=services)
...
def test_context_is_immutable() -> None:
    context = ToolContext(
        ...
        logger=get_logger("test_context_immutable"),
