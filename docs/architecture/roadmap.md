...
Status as of Sprint 9: Sprints 1–5 shipped `core`, `config`, `providers`
...
finally shipped that event bus (`Event`, `EventBus`, `InMemoryEventBus`,
...
[ADR-0008](../adr/0008-event-bus-and-lifecycle-events.md). This time the
recommended slot held; no re-sequencing. What follows is the approved
